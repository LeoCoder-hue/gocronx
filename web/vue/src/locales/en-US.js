export default {
  ...
  task: {
    ...
    enable: 'Enable',
    disable: 'Disable',
    mainTaskTip: 'Main task can configure multiple child tasks. Child tasks will be executed automatically after main task completes.<br>Task type cannot be changed after creation.',
    dependencyTip: 'Strong Dependency: Child tasks run only when main task succeeds<br>Weak Dependency: Child tasks run regardless of main task result',
